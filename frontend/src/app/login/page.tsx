  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6" noValidate>
        ...
        {unverifiedEmail && (
          <div className="rounded-xl border border-blue-200 bg-blue-50 p-4 text-left space-y-3 shadow-sm">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-blue-700 mt-1">
                  We sent a confirmation link to <strong className="font-semibold text-blue-950 underline">{unverifiedEmail}</strong>.
                </p>
              </div>
            </div>
            <button
              ...
              onClick={onResend}
              className="inline-flex items-center gap-2 rounded-lg bg-blue-600 hover:bg-blue-700 px-3.5 py-2 text-xs font-semibold text-white shadow-sm transition-colors disabled:opacity-50"
            >
              {resending ? (
                <>
